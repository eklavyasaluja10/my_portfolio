...
const IMAGES = [
  ...
  { file: 'image65.jpg',   title: 'Frame 004',   series: 'GOLDEN HOUR',      plate: '004', year: '2024', tags: ['golden hour',      'all works'] },
...
function buildCarousel() {
  ...
  // Build slides from first 7 images
  const slides = IMAGES.slice(0, 7);
